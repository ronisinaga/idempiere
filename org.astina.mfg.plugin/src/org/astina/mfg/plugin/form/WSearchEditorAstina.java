 ...
 *
 */
public class WSearchEditorAstina extends WEditor implements ContextMenuListener, ValueChangeListener, IZoomableEditor
{
	...
	private static final CLogger log = CLogger.getCLogger(WSearchEditorAstina.class);

	private static final String IN_PROGRESS_IMAGE = "~./zk/img/progress3.gif";
	
	private ADWindow adwindow;

	public WSearchEditorAstina (GridField gridField, boolean tableEditor, IEditorConfiguration editorConfiguration)
	{
	 ...
	 */
	public WSearchEditorAstina (Lookup lookup, String label, String description, boolean mandatory, boolean readonly, boolean updateable)
	{
	...
	public WSearchEditorAstina(String columnName, boolean mandatory, boolean readonly, boolean updateable,
    		Lookup lookup)
	{
...
//		AEnv.actionRefresh(lookup, value, mandatory);
	 ...
	 */
	public static WSearchEditorAstina createBPartner(int windowNo) {
		...
		try
		{
			...
			return new WSearchEditorAstina ("C_BPartner_ID", false, false, true, lookup);
		}
		catch (Exception e)
		{
	 ...
	 * @return WSearchEditor
	 */
	public static WSearchEditorAstina createProduct(int windowNo) {
		...
		try
		{
			...
			return new WSearchEditorAstina("M_Product_ID", false, false, true, lookup);
		}
		catch (Exception e)
		{
			log.log(Level.SEVERE, "", e);
