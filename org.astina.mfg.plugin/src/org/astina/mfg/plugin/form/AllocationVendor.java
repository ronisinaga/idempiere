...
public class AllocationVendor
{
	public DecimalFormat format = DisplayType.getNumberFormat(DisplayType.Amount);

	/**	Logger			*/
	public static final CLogger log = CLogger.getCLogger(AllocationVendor.class);
...
//	private int			i_multiplier = 10;
	...
	{		
		...
		//Astina 13112021 --Remove condition
		//if (m_AD_Org_ID != 0 )
...
//		paymentTable.setColumnClass(i++, BigDecimal.class, true);      	//  8-Multiplier
	...
	public Vector<Vector<Object>> getInvoiceData(boolean isMultiCurrency, Object date, String trxName)
	{
		...
		//Astina 13112021 remove if dan filter
		//if (m_AD_Org_ID != 0 ) 
