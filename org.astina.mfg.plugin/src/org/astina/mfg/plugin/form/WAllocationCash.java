 ...
 */
public class WAllocationCash extends AllocationCash
	implements IFormController, EventListener<Event>, ValueChangeListener, WTableModelListener
{
	...
	public void dynInit() throws Exception
	{
		...
		//  BPartner
		AD_Column_ID = 1001382; //Astina C_BPartner Employee //COLUMN_C_INVOICE_C_BPARTNER_ID;        //  C_Invoice.C_BPartner_ID
