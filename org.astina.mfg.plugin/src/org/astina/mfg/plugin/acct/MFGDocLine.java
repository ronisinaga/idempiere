...
{	
	 ...
	 *	@param doc header
	 */
	public MFGDocLine (PO po, Doc doc)
	{
		if (po == null)
	...
	/**	Product Costs			*/
	private MFG_ProductCost			m_productCost = null;
	 ...
	 *	@return product cost
	 */
	public MFG_ProductCost getProductCost()
	{
		if (m_productCost == null)
			m_productCost = new MFG_ProductCost (Env.getCtx(), 
	...
	{
		MFG_ProductCost pc = getProductCost();
		int C_OrderLine_ID = getC_OrderLine_ID();
