 ...
 *
 */
public class MFG_MBankTransfer extends MBankTransfer implements DocAction {
	/**
	 * 
	 */
	 ...
	 * @param trxName
	 */
	public MFG_MBankTransfer(Properties ctx, int C_BankTransfer_ID, String trxName) {
	 ...
	 * @param trxName
	 */
	public MFG_MBankTransfer(Properties ctx, ResultSet rs, String trxName)
	{
	...
	public String completeIt() {
		...
		//Astina 281222
		String sql = "select c_doctype_id from c_doctype where ad_client_id=? and name='Bank Transfer Out'";
		int doctype_Out = org.compiere.util.DB.getSQLValue(null, sql, getAD_Client_ID());
				
		paymentBankFrom.setC_DocType_ID(doctype_Out);
		...
		//Astina 281222
		String sql1 = "select c_doctype_id from c_doctype where ad_client_id=? and name='Bank Transfer In'";
		int doctype_in = org.compiere.util.DB.getSQLValue(null, sql1, getAD_Client_ID());
				
		paymentBankTo.setC_DocType_ID(doctype_in);
