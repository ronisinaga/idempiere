...
public class MFG_ProductCost 
{
	 ...
	 *	@param trxName trx
	 */
	public MFG_ProductCost (Properties ctx, int M_Product_ID, int M_AttributeSetInstance_ID, 
		String trxName)
	{
	...
	/**	Logger					*/
	private static CLogger 	log = CLogger.getCLogger (MFG_ProductCost.class);
		...
		String costingMethod, int C_OrderLine_ID, boolean zeroCostsOK)
	{
		...
		//
		BigDecimal cost = MFG_MCost.getCurrentCost (m_product, m_M_AttributeSetInstance_ID, 
